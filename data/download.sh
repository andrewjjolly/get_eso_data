...
if [ "$prompt" != "yes" ]; then
   ...
   then
      ...
      if [ $? -ne 0 ]; then
         ...
         echo "machine dataportal.eso.org login andrewjolly password _yourpassword_"
         prompt="yes"
      fi
   else
      prompt="yes"
...
https://dataportal.eso.org/dataportal_new/file/HARPS.2006-03-19T01:20:59.944
