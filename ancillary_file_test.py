""" 
USING THIS SCRIPT TO TEST DOWNLOADING SCIENCE & ANCILLARY FILES USING A CONE SEARCH PASSING IN RA & DEC ONLY

USES THE ESO ANCILLARY FILE TUTORIAL EMAILED BY ALBERTO MICOL AS A STARTING POINT.
"""
...
query = """
SELECT top 3 access_url 
FROM ivoa.ObsCore 
WHERE instrument_name = 'HARPS' 
AND s_ra BETWEEN 255 AND 260
AND s_dec BETWEEN 4 AND 5
"""
